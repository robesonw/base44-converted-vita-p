...
const Community: React.FC = () => {
    const { data: sharedPlans = [] } = useQuery<MealPlan[]>('sharedMealPlans', () => apiFetch('GET', '/api/shared-meal-plans'));
    const { data: forumPosts = [] } = useQuery<ForumPost[]>('forumPosts', () => apiFetch('GET', '/api/forum-posts'));
    ...
    return (
        <div className="space-y-6">
            <div className="text-center space-y-2">
                ...
                <p className="text-lg text-slate-600">Connect, share, and learn from fellow nutrition enthusiasts</p>
            </div>
