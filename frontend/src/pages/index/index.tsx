            ...
            {[
              {
                ...
                content: 'This platform completely changed my approach to meal planning!'
              },
              {
                name: 'James Chen',
                role: 'Fitness Coach',
                content: 'I recommend it to all my clients. Absolutely game-changing!'
              },
              {
                name: 'Maria Rodriguez',
                role: 'Busy Professional',
                content: 'With AI meal plans that fit my lifestyle, I eat healthier than ever!'
              }
            ].map((review, i) => (
              <Card key={i} className="border-slate-200 shadow-lg">
                <CardContent className="p-6">
                  <p className="text-slate-700 mb-4 italic">"{review.content}"</p>
                  <div>-- {review.name}, {review.role}</div>
                </CardContent>
              </Card>
            ))}
          </div>
